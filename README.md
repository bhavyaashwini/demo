...
Run `ng generate component component-employeeskill` to generate a new component. You can also use `ng generate directive|pipe|service|class|guard|interface|enum|module`.
